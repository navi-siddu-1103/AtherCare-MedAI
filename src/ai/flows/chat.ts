...
const chatPrompt = ai.definePrompt({
  ...
  Engage in a helpful conversation with the user. Be encouraging and always remind them to consult a qualified healthcare professional for any medical advice or diagnosis. Do not provide medical advice yourself.
